...
class ProfileContent extends React.Component{
    ...
    onClickSubmit() {
        console.log("clicking my favorites" + this.props);
        ...
        return(
            <div>
                <div className="list-group">
                    ...
                    <Link to="/myfavourites" className="list-group-item" onClick={this.onClickSubmit}><img src={favourites} className="sidebar-icon"/>Favourites</Link>
